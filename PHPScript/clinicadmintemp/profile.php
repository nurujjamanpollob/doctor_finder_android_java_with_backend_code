...
<div class="container-fluid mimin-wrapper">
    ...
    <div id="content">
        <div class="panel">
            <div class="panel-body">
                <div class="col-md-12 col-sm-12">
                    <h4 class="animated fadeInLeft"><i class="icon icon-list"></i> Profile</h4>
        ...
        <div class="col-md-2">
            <a href="profile.php" class="btn btn-primary">Reset Filter</a>
        </div>
        <script>
            function redirectpage(val){
                window.location='profile.php?sp_category='+val;
            }
        </script>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                            ...
                            if(isset($_GET['sp_category']) && $_GET['sp_category'] != ""){
                                ...
                                {
                                    $search = $_GET['search'];
                                    $qutotal = $admin->selectallprofile($search, "searchtotal", "none", "none" ,$sp_id);
                                    $query = $admin->selectallprofile($search, "search", $start, $per_page,$sp_id);
                                }
                                else
                                {
                                    $query = $admin->selectallprofile("none", "none", $start, $per_page,$sp_id);
                                    $qutotal = $admin->selectallprofile("none", "total", "none", "none",$sp_id);
                                }
                            }
                            else
                            {
                                ...
                                {
                                    $search = $_GET['search'];
                                    $qutotal = $admin->selectallprofile($search, "searchtotal", "none", "none","none");
                                    $query = $admin->selectallprofile($search, "search", $start, $per_page,"none");
                                } else {
                                    $query = $admin->selectallprofile("none", "none", $start, $per_page,"none");
                                    $qutotal = $admin->selectallprofile("none", "total", "none", "none","none");
                                }
                            }?>
                                    ...
                                    foreach ($query as $res)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <a href="editprofiles.php?<?php echo $enc_str; ?>"  class="badge badge-warning"><i class="icon-pencil"></i> Edit</a>
                        ...
                        <div class="col-md-6">
                            <ul class="pagination pagination-without-border pull-left m-t-0">
                                ...
                                if(isset($_GET['sp_category']) && $_GET['sp_category'] != ""){
                                    $pagename="profile.php?sp_category=".$_GET['sp_category']."&";
                                }
                                else
                                {
