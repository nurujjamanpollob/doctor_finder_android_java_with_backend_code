...
<head>
    ...
    <title>Clinic Admin | Pharmacy Profile</title>
    <!-- start: Css -->
        ...
        <div class="panel">
            <div class="panel-body">
                <div class="col-md-12 col-sm-12">
                    <h4 class="animated fadeInLeft"><i class="icon icon-list"></i> Pharmacy</h4>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 padding-0" style="padding-bottom:20px;">
                            ...
                            if(isset($_GET['sp_category']) && $_GET['sp_category'] != ""){
                                ...
                                {
                                    $search = $_GET['search'];
                                    $qutotal = $admin->selectallpharmacyprofile($search, "searchtotal", "none", "none" ,$sp_id);
                                    $query = $admin->selectallpharmacyprofile($search, "search", $start, $per_page,$sp_id);
                                }
                                else
                                {
                                    $query = $admin->selectallpharmacyprofile("none", "none", $start, $per_page,$sp_id);
                                    $qutotal = $admin->selectallpharmacyprofile("none", "total", "none", "none",$sp_id);
                                }
                            }
                            else
                            {
                                ...
                                {
                                    $search = $_GET['search'];
                                    $qutotal = $admin->selectallpharmacyprofile($search, "searchtotal", "none", "none","none");
                                    $query = $admin->selectallpharmacyprofile($search, "search", $start, $per_page,"none");
                                } else {
                                    $query = $admin->selectallpharmacyprofile("none", "none", $start, $per_page,"none");
                                    $qutotal = $admin->selectallpharmacyprofile("none", "total", "none", "none","none");
                                }
                            }?>
                        ...
                        <div class="col-md-6">
                            <ul class="pagination pagination-without-border pull-left m-t-0">
                                ...
                                if(isset($_GET['sp_category']) && $_GET['sp_category'] != ""){
                                    $pagename="pharmacy.php?sp_category=".$_GET['sp_category']."&";
                                }
                                else
                                {
                                    $pagename="pharmacy.php?";
                                }
                                if($totalpharmacy){
                                    if(isset($_GET['page'])) {
                                        $pageval = $_GET['page'];
